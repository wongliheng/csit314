<?php
	session_start();
    include('controller/ownerViewVisitReportsController.php');
    ...
    $visitReportsController = new ownerViewVisitReportsController();
    ...
    if (isset($_POST['submitDay'])) {
        ...
        $dailyReport = $visitReportsController->viewDailyReport($day, $month);
	}
    ...
    if (isset($_POST['submitWeek'])) {
        ...
        $weeklyReport = $visitReportsController->viewWeeklyReport($week, $month);
	}

    if (isset($_POST['submitMonth'])) {
        $month = $_POST['month'];

        $monthlyReport = $visitReportsController->viewMonthlyReport($month);
	}
?>
